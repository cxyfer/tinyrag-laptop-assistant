...
Answer only from the retrieved context. Preserve exact model names, numbers, symbols, units, and variants.
If the context does not contain the answer, reply: {INSUFFICIENT_CONTEXT_ANSWER}
